...
def graph_search(problem, fringe):
    ...
    nodes_generated = 1  # Generated nodes counter
    nodes_visited = 0  # Visited nodes counter
    ...
    while fringe:
        ...
        if problem.goal_test(node.state):
            ...
            return node, nodes_generated, nodes_visited, start, end
    ...
    return None, nodes_generated, nodes_visited, start, end
...
def branch_and_bound_priority(problem):
    """Implementación de Branch and Bound con prioridad."""
    return graph_search(problem, PriorityQueue())

def branch_and_bound_heuristicpriority(problem):
    """Branch and Bound con heurística."""
    return graph_search(problem, HeuristicPriorityQueue(problem.h))
